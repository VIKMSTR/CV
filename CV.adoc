...
* *09/2023 - (now) Senior Backend Developer in Expertalabs*
    ...
    ** .NET (C#/ASPCore) development of the embedded device services.
...
After finishing with the project (along with putting the system in production), I took a part in a #C♯# development again (after all these years). This time in a modern ASPCore .NET framework, using C#. Thanks to a new multiplatform compatibility, this technology was used as an extension of embedded device firmware, running on #GNU/Linux#.
